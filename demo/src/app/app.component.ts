...
export class AppComponent implements OnInit {
  ...
  themes: ITheme[] = [
    ...
    // { name: '"rounded"', class: 'dark', options: { axis: 'x', theme: 'rounded', scrollButtons: { enable: true } } },
    // { name: '"rounded-dark"', class: 'light', options: { axis: 'x', theme: 'rounded-dark', scrollButtons: { enable: true } } },
    { name: '"rounded-dots"', class: 'dark', options: { axis: 'x', theme: 'rounded-dots', scrollButtons: { enable: true } } },
    // { name: '"rounded-dots-dark"', class: 'light', options: { axis: 'x', theme: 'rounded-dots-dark', scrollButtons: { enable: true } } },
